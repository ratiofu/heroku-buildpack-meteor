...
```
% heroku create --buildpack https://github.com/tjconsult/heroku-buildpack-meteor.git
```
...
```
% heroku buildpacks:set https://github.com/tjconsult/heroku-buildpack-meteor.git
```
