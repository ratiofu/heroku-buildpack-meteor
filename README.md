...
```
% heroku create --buildpack https://github.com/ratiofu/heroku-buildpack-meteor.git
```
...
```
% heroku buildpacks:set https://github.com/ratiofu/heroku-buildpack-meteor.git
```
